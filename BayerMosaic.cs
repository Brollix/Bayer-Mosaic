...
namespace BayerMatrix
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            this.Width = 540;//Width  of the Windows_Form.
            this.Height = 540;//Height of the Windows_Form.                                              
        }

        public void Form1_Paint(object sender, PaintEventArgs e)
        {
            int w = 60; //Width  Value of each Rectangle.
            int h = 60; //Heigth Value of each Rectangle.

            int x = 0; //Inicial Value of the X Coordinate.
            int y = 0; //Inicial Value of the Y Coordinate.

            int cols = 6; //Amount of Columns wanted.
            int rows = 6; //Amount of Rows    wanted.

            for (int i = 0; i < rows/2; i++)//Loop for the Rows.
            {
                x = 0; //initializes x value at 0.
                for (int j = 0; j < cols/2; j++) //Loop for the Columns.
                {
                    //Defines Colors respective to the "RGGB" Array Pattern
                    ...
                    SolidBrush g1 = new SolidBrush( Color.Green      ); //Creates Brush "g1" with Color "Green".
